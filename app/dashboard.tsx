...
const ALL20_PRESCRIPTIONS: Record<string, KpiPrescription> = {
  ...
  bepDay: {
    analysis: [
      "현재 BEP 10일 — Unit Economics Payback 기준(≤12일) 대비 2일 조기 달성",
      "월초 10일 BEP = 이후 20일이 순수 이익 창출 기간",
      "노쇼·취소 해결 시 BEP 7~8일 달성 — 업계 최상위 진입",
    ],
    solution: [
      "① 현 월초 예약 밀도 전략 유지",
      "② 노쇼·당일 취소 감소로 BEP 7일 목표 설정",
      "③ 분기마다 BEP 달성일 추이 모니터링",
    ],
    effect: [
      "BEP 7일 달성 시 순이익 창출 기간 23일 확보",
      "연간 순이익 +1,200만 원 추가 창출 가능",
      "Unit Economics Payback 최우수 = 확장 투자 최적 타이밍",
    ],
    action: "BEP 7일 목표 달성 계획",
  },
  monthlyRevenue: {
    analysis: [
